...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: 4332, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2871681132), utc_offset: 3614, dst_offset: 0, name: "SET" },
        Transition { occurs_at: Some(-2208992414), utc_offset: 3600, dst_offset: 0, name: "CET" },
