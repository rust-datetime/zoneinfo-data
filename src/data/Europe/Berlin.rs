...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Berlin",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 3208, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2422054408), utc_offset: 3600, dst_offset: 0, name: "CET" },
        ...
        Transition { occurs_at: Some(-776563200), utc_offset: 3600, dst_offset: 7200, name: "CEMT" },
        Transition { occurs_at: Some(-765936000), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-761180400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-748479600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-733273200), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-717631200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-714610800), utc_offset: 3600, dst_offset: 7200, name: "CEMT" },
        Transition { occurs_at: Some(-710380800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
