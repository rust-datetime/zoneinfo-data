...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: 3020, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2524524620), utc_offset: 3020, dst_offset: 0, name: "CMT" },
        Transition { occurs_at: Some(-2398294220), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-1692496800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-1680490800), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-935110800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        ...
        Transition { occurs_at: Some(-769388400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-747010800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-736383600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-715215600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-706748400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-683161200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-675298800), utc_offset: 3600, dst_offset: 0, name: "CET" },
