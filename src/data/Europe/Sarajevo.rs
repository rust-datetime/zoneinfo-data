...
pub static ZONE: StaticTimeZone<'static> = StaticTimeZone {
    ...
    fixed_timespans: FixedTimespanSet {
        ...
        rest: &[
        (-2713915320, FixedTimespan {  // 1883-11-31T22-38-00 UTC
            offset: 3600,  // UTC offset 3600, DST offset 0
            is_dst: false,
            name:   Cow::Borrowed("CET"),
        }),
        (-905824800, FixedTimespan {  // 1941-03-18T22-00-00 UTC
        ...
        (-777942000, FixedTimespan {  // 1945-04-08T1-00-00 UTC
            offset: 7200,  // UTC offset 3600, DST offset 3600
            is_dst: true,
            name:   Cow::Borrowed("CEST"),
        }),
        (-766627200, FixedTimespan {  // 1945-08-16T0-00-00 UTC
            offset: 3600,  // UTC offset 3600, DST offset 0
            is_dst: false,
            name:   Cow::Borrowed("CET"),
        }),
