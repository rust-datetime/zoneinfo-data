...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Andorra",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 364, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2177453164), utc_offset: 0, dst_offset: 0, name: "WET" },
        Transition { occurs_at: Some(-733881600), utc_offset: 3600, dst_offset: 0, name: "CET" },
