...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Rome",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 2996, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-3259097396), utc_offset: 2996, dst_offset: 0, name: "RMT" },
        Transition { occurs_at: Some(-2403564596), utc_offset: 3600, dst_offset: 0, name: "CET" },
        ...
        Transition { occurs_at: Some(-798080400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        ...
        Transition { occurs_at: Some(107910000), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(118188000), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(138754800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(149637600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(170809200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(181090800), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(202258800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(212540400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(233103600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(243990000), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(265158000), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(276044400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(296607600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(307494000), utc_offset: 3600, dst_offset: 0, name: "CET" },
