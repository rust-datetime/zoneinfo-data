...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Oslo",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 2580, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2366757780), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-1691884800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-1680573600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-927511200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        ...
        Transition { occurs_at: Some(-765327600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-340844400), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-324514800), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-308790000), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-293065200), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-277340400), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-261615600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-245890800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-230166000), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-214441200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-198716400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-182991600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-166662000), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-147913200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-135212400), utc_offset: 3600, dst_offset: 0, name: "CET" },
