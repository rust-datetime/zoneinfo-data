...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Zurich",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 2048, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-3675198848), utc_offset: 1786, dst_offset: 0, name: "BMT" },
        Transition { occurs_at: Some(-2385246586), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-904435200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-891129600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-872985600), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-859680000), utc_offset: 3600, dst_offset: 0, name: "CET" },
