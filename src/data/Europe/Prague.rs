...
pub const ZONE: Zone<'static> = Zone {
    name: "Europe/Prague",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 3464, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-3786829064), utc_offset: 3464, dst_offset: 0, name: "PMT" },
        Transition { occurs_at: Some(-2469401864), utc_offset: 3600, dst_offset: 0, name: "CET" },
        ...
        Transition { occurs_at: Some(-798076800), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-780534000), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-761180400), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-746578800), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        Transition { occurs_at: Some(-733359600), utc_offset: 3600, dst_offset: 0, name: "CET" },
        Transition { occurs_at: Some(-716425200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
        ...
        Transition { occurs_at: Some(-654217200), utc_offset: 3600, dst_offset: 3600, name: "CEST" },
