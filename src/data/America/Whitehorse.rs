...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: -32388, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2188998012), utc_offset: -32400, dst_offset: 0, name: "YST" },
        ...
        Transition { occurs_at: Some(-81961200), utc_offset: -28800, dst_offset: 0, name: "PST" },
