...
pub const ZONE: Zone<'static> = Zone {
    name: "America/Denver",
    transitions: &[
        Transition { occurs_at: None, utc_offset: -18004, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2717650792), utc_offset: -25200, dst_offset: 0, name: "MST" },
        ...
        Transition { occurs_at: Some(-1570374000), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1551628800), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-1538924400), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1534089600), utc_offset: -25200, dst_offset: 0, name: "MST" },
        ...
        Transition { occurs_at: Some(-147884400), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-131558400), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-116434800), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-100108800), utc_offset: -25200, dst_offset: 0, name: "MST" },
