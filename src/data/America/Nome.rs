...
pub const ZONE: Zone<'static> = Zone {
    name: "America/Nome",
    transitions: &[
        Transition { occurs_at: None, utc_offset: 46701, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-3225358701), utc_offset: -39502, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2188947698), utc_offset: -39600, dst_offset: 0, name: "NST" },
        Transition { occurs_at: Some(-880196400), utc_offset: -39600, dst_offset: 3600, name: "NWT" },
        Transition { occurs_at: Some(-769395600), utc_offset: -39600, dst_offset: 3600, name: "NPT" },
        ...
        Transition { occurs_at: Some(436363200), utc_offset: -32400, dst_offset: 0, name: "YST" },
