...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: -23168, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-1998668032), utc_offset: -25200, dst_offset: 0, name: "MST" },
        ...
        Transition { occurs_at: Some(-1600614000), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1596816000), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-1567954800), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1551628800), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-1536505200), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1523203200), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-1504450800), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1491753600), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(-1473001200), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(-1459699200), utc_offset: -25200, dst_offset: 0, name: "MST" },
        ...
        Transition { occurs_at: Some(136371600), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
        Transition { occurs_at: Some(152092800), utc_offset: -25200, dst_offset: 0, name: "MST" },
        Transition { occurs_at: Some(167821200), utc_offset: -25200, dst_offset: 3600, name: "MDT" },
