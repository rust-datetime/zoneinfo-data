...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        ...
        Transition { occurs_at: Some(-536457600), utc_offset: -28800, dst_offset: 0, name: "PST" },
        Transition { occurs_at: Some(-147888000), utc_offset: -28800, dst_offset: 7200, name: "PDDT" },
        Transition { occurs_at: Some(-131558400), utc_offset: -28800, dst_offset: 0, name: "PST" },
        Transition { occurs_at: Some(294228000), utc_offset: -25200, dst_offset: 0, name: "MST" },
