...
pub const ZONE: Zone<'static> = Zone {
    name: "America/Recife",
    transitions: &[
        Transition { occurs_at: None, utc_offset: -6024, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-1767219576), utc_offset: -10800, dst_offset: 0, name: "BRT" },
        ...
        Transition { occurs_at: Some(971575200), utc_offset: -10800, dst_offset: 0, name: "BRT" },
