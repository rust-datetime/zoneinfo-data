...
pub const ZONE: Zone<'static> = Zone {
    name: "America/Maceio",
    transitions: &[
        Transition { occurs_at: None, utc_offset: -5828, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-1767219772), utc_offset: -10800, dst_offset: 0, name: "BRT" },
        ...
        Transition { occurs_at: Some(972180000), utc_offset: -10800, dst_offset: 0, name: "BRT" },
