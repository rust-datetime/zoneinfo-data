...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: -14816, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2366740384), utc_offset: -18000, dst_offset: 0, name: "EST" },
        ...
        Transition { occurs_at: Some(-923252400), utc_offset: -18000, dst_offset: 3600, name: "EDT" },
