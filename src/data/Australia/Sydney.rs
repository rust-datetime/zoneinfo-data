...
pub const ZONE: Zone<'static> = Zone {
    ...
    transitions: &[
        Transition { occurs_at: None, utc_offset: 36292, dst_offset: 0, name: "LMT" },
        Transition { occurs_at: Some(-2364113092), utc_offset: 36000, dst_offset: 0, name: "AEST" },
        ...
        Transition { occurs_at: Some(386697600), utc_offset: 36000, dst_offset: 0, name: "AEST" },
        ...
        Transition { occurs_at: Some(794332800), utc_offset: 36000, dst_offset: 0, name: "AEST" },
